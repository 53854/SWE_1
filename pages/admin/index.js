...
function ExpenseList() {
    const ref = firestore.collection('users').doc(auth.currentUser.uid).collection('expenses');
  ...
  function CreateNewExpense() {
    ...
    const createExpense = async (e) => {
      ...
      const ref = firestore.collection('users').doc(uid).collection('expenses').doc(slug);
